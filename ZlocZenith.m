function varargout = ZlocZenith(varargin)
% ZLOCZENITH MATLAB code for ZlocZenith.fig
%      ZLOCZENITH, by itself, creates a new ZLOCZENITH or raises the existing
%      singleton*.
%
%      H = ZLOCZENITH returns the handle to a new ZLOCZENITH or the handle to
%      the existing singleton*.
%
%      ZLOCZENITH('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in ZLOCZENITH.M with the given input arguments.
%
%      ZLOCZENITH('Property','Value',...) creates a new ZLOCZENITH or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before ZlocZenith_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to ZlocZenith_OpeningFcn via varargin.
%
...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_OpeningFcn', @ZlocZenith_OpeningFcn, ...
                   'gui_OutputFcn',  @ZlocZenith_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before ZlocZenith is made visible.
function ZlocZenith_OpeningFcn(hObject, eventdata, handles, varargin)
...
% UIWAIT makes ZlocZenith wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = ZlocZenith_OutputFcn(hObject, eventdata, handles) 
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
tetherLength = checkHeight(handles.programSettings)
